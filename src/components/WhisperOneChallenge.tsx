...
const WhisperOneChallenge = () => {
  ...
  useEffect(() => {
    if (currentChallenge?.id === "crypto-1") {
        ...
        <div className="lg:col-span-9 lg:col-start-2 xl:col-span-9 xl:col-start-2 flex flex-col justify-center">
          ...
          >
            <Card className="p-12 md:p-16 xl:p-20 bg-cyber-black bg-opacity-80 border border-cyber-blue-200 text-lg xl:text-xl min-h-[500px] flex flex-col justify-center">
              <div className="mb-6">
                <h1 className="text-2xl font-cyber text-cyber-blue-100 mb-2">🔐 Whisper One – Bronze</h1>
                <div className="flex items-center gap-4">
                  <p className="text-white text-lg flex-1">Their first note says "Pngf vf sha!" — looks harmless, right? But scroll further, and you'll find something more encrypted… maybe the real strike hides beneath the joke.</p>
                  <Button
                    onClick={() => {
                      const link = document.createElement('a');
                      link.href = '/assets/challenges/whisper1.txt';
                      link.download = 'whisper1.txt';
              ...
              <div className="relative z-10 text-center">
                ...
                <motion.div variants={itemVariants} className="flex flex-col sm:flex-row justify-center gap-4 mt-4">
                  <Button
                    ...
                    onClick={() => navigate('/challenge/crypto-2')}
                  >
...
export default WhisperOneChallenge; 