...
const ThreeSecondBurstGold = () => {
  ...
  useEffect(() => {
    if (currentChallenge?.id === "forensics-3") {
        ...
        <div className="lg:col-span-9 lg:col-start-2 xl:col-span-9 xl:col-start-2 flex flex-col justify-center">
          ...
          >
            <Card className="p-12 md:p-16 xl:p-20 bg-cyber-black bg-opacity-80 border border-cyber-blue-200 text-lg xl:text-xl min-h-[500px] flex flex-col justify-center">
              <div className="mb-6">
                <h1 className="text-2xl font-cyber text-cyber-blue-100 mb-2">Three-Second Burst – Gold</h1>
                <div className="flex items-center gap-4">
                  <p className="text-white text-lg flex-1">Engineers grabbed only three seconds of network traffic during the last hijack. Check if any secret left the studio.</p>
                  <Button
                    onClick={() => {
                      const link = document.createElement('a');
                      link.href = '/assets/challenges/burst.pcap';
                      link.download = 'burst.pcap';
              ...
              {/* Tool Hints Section */}
              <div className="mb-6">
                <h2 className="text-cyber-yellow text-sm font-bold mb-2">Available Tools</h2>
                <div className="space-y-2">
                  <a
                    href="https://apackets.com"
                    target="_blank"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-center gap-2 bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white px-6 py-3 rounded-lg transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:shadow-cyan-500/20 font-semibold"
                  >
                    <span className="text-xl">🧪</span>
                    CyberChef
                  </a>
              ...
              <div className="relative z-10 text-center">
                ...
                <motion.div variants={itemVariants} className="flex flex-col sm:flex-row justify-center gap-4 mt-4">
                  <Button
                    ...
                    onClick={() => navigate('/challenge/forensics-4?showTutorial=true')}
                  >
...
export default ThreeSecondBurstGold;