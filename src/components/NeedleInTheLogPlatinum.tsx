...
const NeedleInTheLogPlatinum = () => {
  ...
  useEffect(() => {
    if (currentChallenge?.id === "forensics-4") {
        ...
        <div className="lg:col-span-9 lg:col-start-2 xl:col-span-9 xl:col-start-2 flex flex-col justify-center">
          ...
          >
            <Card className="p-12 md:p-16 xl:p-20 bg-cyber-black bg-opacity-80 border border-cyber-blue-200 text-lg xl:text-xl min-h-[500px] flex flex-col justify-center">
              <div className="mb-6">
                <h1 className="text-2xl font-cyber text-cyber-blue-100 mb-2">Needle in the Log – Platinum</h1>
                <div className="flex items-center gap-4">
                  <p className="text-white text-lg flex-1">Right before the hijack, the studio's web panel saw a strange URL. It might hide the next coordinates in an SQL trick.</p>
                  <Button
                    onClick={() => {
                      const link = document.createElement('a');
                      link.href = '/assets/challenges/studio_access.log';
                      link.download = 'studio_access.log';
              ...
              <div className="relative z-10 text-center">
                ...
                <motion.div variants={itemVariants} className="flex flex-col sm:flex-row justify-center gap-4 mt-4">
                  <Button
                    ...
                    onClick={() => navigate('/challenge/forensics-5')}
                  >
...
export default NeedleInTheLogPlatinum;